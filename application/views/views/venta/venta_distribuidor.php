...
<div id="pepe2">
    <div class="container ">
        ...
        <div class=" col-sm-offset-1">
            ...
            <form class="form-horizontal col-sm-offset-1 " role="form" method="post" action="/index.php/venta/ventaDistribuidor">
            ...
            <div id="pepe2">
                ...
                <div class="col-sm-3 ">
                 ...
                 <div class="form-group ">
                     <label  class="col-sm-1 control-label ">Distribuidor</label>
                <div class="col-sm-3 ">
                   <select name='enteID'>
                       <?php
