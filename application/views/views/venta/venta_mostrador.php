...
<div id="pepe2">
    <div class="container ">
        ...
        <div class=" col-sm-offset-1">
            <h2> Ingrese la nueva Venta de mostrador</h2><br>      
        </div>
           
        
            <form class="form-horizontal col-sm-offset-1 " role="form" method="post" action="/index.php/venta/ventaMostrador">
